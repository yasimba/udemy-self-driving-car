...
image = cv2.imread('./images/test_image.jpg')# image is read as an array containing 0 to 255
lane_image = np.copy(image) # need to work with a copy
...
combo_image = cv2.addWeighted(lane_image,0.8,line_image,1,1) #combine black image with color image
